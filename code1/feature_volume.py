...
from .encoder_utils.grid_sample import grid_sample_2d
from .encoder_utils.cnn3d import VolumeRegularization
from .encoder_utils.fmt.module import CostRegNetWeight
...
class MVSVolume(nn.Module):
    ...
    def forward(self, batch, volume):
        """
        feats: [B NV C H W], NV: number of views (source features)
        batch: to get the poses for homography
        """
        vol_feat, weight = self.cost_reg_2(volume)
        
        return vol_feat, weight
