...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_dir', type=str, default='/home/yourname/3d-recon/datasets/SampleSet')
    ...
    for scan in scans:
        if args.mode == 'mesh':
            ...
            # data = '/home/yj/3d-recon/UFORecon/outputs/mesh/dtu_scan114_mesh.ply'
